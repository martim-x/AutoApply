(() => {
  ...
  const STRINGS = {
    ru: {
      ...
      "remote.help": "Тап по полю в трансляции, затем «Клавиатура» — откроется клавиатура телефона.",
    ...
    en: {
      ...
      "remote.help": "Tap a field on the stream, then “Keyboard” to open your phone’s soft keyboard.",
      "stats.queued": "Queued",
