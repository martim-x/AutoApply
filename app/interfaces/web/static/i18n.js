(() => {
  ...
  const STRINGS = {
    ru: {
      ...
      "parse.schedule.hint": "Парсинг: {times} ({tz}) · rules={rules} · след. {when} · последний {last}",
      ...
      "launch.schedule.hint": "Сохраняется в launch.json · PARSE_SCHEDULE_ENABLED — kill-switch в env",
      "launch.schedule.enabled": "Включено в профиле",
      "launch.schedule.timezone": "Timezone",
    ...
    en: {
      ...
      "parse.schedule.hint": "Parse: {times} ({tz}) · rules={rules} · next {when} · last {last}",
      ...
      "launch.schedule.hint": "Stored in launch.json · PARSE_SCHEDULE_ENABLED is the env kill-switch",
