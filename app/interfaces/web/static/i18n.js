(() => {
  ...
  const STRINGS = {
    ru: {
      ...
      "launch.criteria.aria": "Открыть критерии запуска",
      ...
      "remote.hint": "Remote browser: screencast с сервера. Войдите на rabota.by в окне ниже.",
      "remote.title": "Remote browser",
      ...
      "queue.title": "Очередь (HIGH → MEDIUM → LOW)",
      "th.cat": "Кат.",
      "th.score": "Score",
      "th.title": "Вакансия",
      "th.filter": "Фильтр",
    ...
    en: {
      ...
      "workspace.hh": "rabota.by / hh",
      "workspace.linkedin": "LinkedIn",
      "linkedin.login": "Sign in to LinkedIn",
      "linkedin.network": "Grow network",
      "linkedin.vacancies": "Collect jobs",
      "linkedin.criteria": "LI criteria",
      ...
      "launch.criteria.aria": "Open launch criteria",
      ...
      "stop": "Stop",
      "status.ready": "Ready",
      "remote.hint": "Remote browser: server screencast. Sign in to rabota.by in the window below.",
      "remote.title": "Remote browser",
      "remote.close": "Close",
      ...
      "stats.session_ok": "ok",
      "stats.session_no": "no",
      "queue.title": "Queue (HIGH → MEDIUM → LOW)",
      "th.cat": "Cat",
      "th.score": "Score",
      "th.title": "Title",
      "th.filter": "Filter",
