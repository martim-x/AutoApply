(() => {
  ...
  const STRINGS = {
    ru: {
      ...
      "status.lights.group": "Индикаторы статуса",
      "status.light.hh": "rabota.by / hh",
      "status.light.li": "LinkedIn",
    ...
    en: {
      ...
      "status.lights.group": "Status indicators",
      "status.light.hh": "rabota.by / hh",
      "status.light.li": "LinkedIn",
